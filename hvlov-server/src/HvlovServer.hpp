...
namespace hvlov
{
    ...
    public:
         ...
         * @param hvlovEntrySerializer The service used to serialize HvlovEntries.
    ...
    private:
        ...
        //! The service used to serialize HvlovEntries.
        const std::unique_ptr<IHvlovEntrySerializer> _hvlovEntrySerializer;
